...
```bash
curl -fsSL https://github.com/windmilleng/tilt/releases/download/v0.10.5/tilt.0.10.5.mac.x86_64.tar.gz | tar -xzv tilt && \
...
```bash
curl -fsSL https://github.com/windmilleng/tilt/releases/download/v0.10.5/tilt.0.10.5.linux.x86_64.tar.gz | tar -xzv tilt && \
  sudo mv tilt /usr/local/bin/tilt
```
