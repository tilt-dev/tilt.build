...
asdf install tilt 0.18.11
asdf global tilt 0.18.11
```
...
```bash
curl -fsSL https://github.com/tilt-dev/tilt/releases/download/v0.18.11/tilt.0.18.11.mac.x86_64.tar.gz | tar -xzv tilt && \
...
```bash
curl -fsSL https://github.com/tilt-dev/tilt/releases/download/v0.18.11/tilt.0.18.11.linux.x86_64.tar.gz | tar -xzv tilt && \
  sudo mv tilt /usr/local/bin/tilt
```
