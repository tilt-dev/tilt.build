...
```bash
curl -fsSL https://github.com/tilt-dev/tilt/releases/download/v0.14.1/tilt.0.14.1.mac.x86_64.tar.gz | tar -xzv tilt && \
...
```bash
curl -fsSL https://github.com/tilt-dev/tilt/releases/download/v0.14.1/tilt.0.14.1.linux.x86_64.tar.gz | tar -xzv tilt && \
  sudo mv tilt /usr/local/bin/tilt
```
