...
```
$ curl -L https://github.com/windmilleng/tilt/releases/download/v0.7.7/tilt.0.7.7.mac.x86_64.tar.gz | tar -xzv tilt && \
...
```
$ curl -L https://github.com/windmilleng/tilt/releases/download/v0.7.7/tilt.0.7.7.linux.x86_64.tar.gz | tar -xzv tilt && \
    sudo mv tilt /usr/local/bin/tilt
```
