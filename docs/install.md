...
```bash
curl -fsSL https://github.com/windmilleng/tilt/releases/download/v0.10.16/tilt.0.10.16.mac.x86_64.tar.gz | tar -xzv tilt && \
...
```bash
curl -fsSL https://github.com/windmilleng/tilt/releases/download/v0.10.16/tilt.0.10.16.linux.x86_64.tar.gz | tar -xzv tilt && \
  sudo mv tilt /usr/local/bin/tilt
```
