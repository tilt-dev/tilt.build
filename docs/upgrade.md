...
```bash
curl -L https://github.com/tilt-dev/tilt/releases/download/v0.14.2/tilt.0.14.2.mac.x86_64.tar.gz | tar -xzv tilt && \
...
```bash
curl -L https://github.com/tilt-dev/tilt/releases/download/v0.14.2/tilt.0.14.2.linux.x86_64.tar.gz | tar -xzv tilt && \
    sudo mv tilt /usr/local/bin/tilt
```
