...
```bash
curl -L https://github.com/windmilleng/tilt/releases/download/v0.9.5/tilt.0.9.5.mac.x86_64.tar.gz | tar -xzv tilt && \
...
```bash
curl -L https://github.com/windmilleng/tilt/releases/download/v0.9.5/tilt.0.9.5.linux.x86_64.tar.gz | tar -xzv tilt && \
    sudo mv tilt /usr/local/bin/tilt
```
